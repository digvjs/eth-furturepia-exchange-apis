    ...
    */
    transferToken: async (req, res) => {
        ...
        try {
            ...
            // Get decimals
            let decimals = await tokenContract.methods.decimals().call();
            let tokenValue = parseFloat(value * 10 ** decimals);
            let fromAccount = web3.eth.accounts.wallet.add(privateKey);
            
            tokenContract.methods.transfer(walletAddr, tokenValue)
            .send({
